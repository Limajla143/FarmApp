...
import { userAdminValidation } from "./userAdminValidation";
...
export default function UseAdminForm({user, cancelEdit}: Props) {
    const { control, reset, handleSubmit, watch, formState: { isDirty, isSubmitting } } = useForm({
        resolver: yupResolver<any>(userAdminValidation)
    });
